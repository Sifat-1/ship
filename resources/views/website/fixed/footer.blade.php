<section class="section section-default">
    <div class="section-inner">
      <div class="container">
        <div class="row">
          <div class="col-xs-12 col-md-2 col-sm-2 text-center hidden-xs">
          ...
          {{-- <div class="thm-footer-content col-xs-2 col-md-2 col-sm-12"> --}}
            {{-- <ul style="list-style: none;"> --}}
              ...
              <li><a style="color: #fff" href="https://www.pmo.gov.bd/" target="_blank">&nbsp; &raquo;&nbsp; Prime Minister&#039;s Office </a></li>
      ...
      <div class="row">
        ...
        <!-- <div class="col-sm-5">
          <div class=" social pull-right">
            ...
            <ul style="list-style: none;">
              <li>Total Visitor: 
                <img src="https://hitwebcounter.com/counter/counter.php?page=6969645&style=0025&nbdigits=9&type=page&initCount=0" title="IP Address" Alt="IP Address"   border="0" >
              </li>
            </ul>
          </div>
        </div>-->
